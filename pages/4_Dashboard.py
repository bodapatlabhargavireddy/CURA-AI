...
intensity = st.select_slider("Intensity:", options=["Rest", "Light", "Moderate", "Heavy"], value="Moderate")
    ...
    with st.spinner("Connecting to Gemini..."):
        try:
            ...
            prompt = (
                ...
                f"Goal: {goal}. Medical: {health_issues}. "
                f"Target: {cal}kcal, {protein_target}g protein. "
                f"Must include a workout for {step_goal} steps."
            )
            ...
            st.error("🚨 Connection Busy. Please wait 30 seconds and try again.")
